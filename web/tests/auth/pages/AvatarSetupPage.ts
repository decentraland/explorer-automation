...
async function clickInsideElement(page: Page, locator: Locator, xPercent: number, yPercent: number): Promise<void> {
...
async function selectRandomGridItem(
  ...
  await clickInsideElement(page, locator, GRID_X_START + col * GRID_DX, GRID_Y_START + row * GRID_DY)
}
